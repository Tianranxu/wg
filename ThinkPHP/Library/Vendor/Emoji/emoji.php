...
class emoji {
	...
	public function emoji_docomo_to_unified($text){ return emoji_convert($text, 'docomo_to_unified'); }
	public function emoji_kddi_to_unified($text){ return emoji_convert($text, 'kddi_to_unified'); }
	public function emoji_softbank_to_unified($text){ return emoji_convert($text, 'softbank_to_unified'); }
	public function emoji_google_to_unified($text){ return emoji_convert($text, 'google_to_unified'); }
